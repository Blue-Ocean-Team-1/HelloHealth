...
const FromFields = ({ formEntries, fieldsArr, handleChange }) => (
  <>
    ...
    < >
      {!isLoginForm ? (
        <>
          ...
          <form>
            <FormFields fieldsArr={SignupFormFields} handleChange={handleChange} formEntries={formEntries} />
        ...
        <>
          ...
          <form>
            <FormFields fieldsArr={LoginFormFields} handleChange={handleChange} formEntries={formEntries} />
      ...
      <button onClick={() => handleAccountSubmit(signInWithGoogle)}>Sign In With Google</button>
      <button onClick={() => handleAccountSubmit(signInWithFacebook)}> Sign In With Facebook</button >
